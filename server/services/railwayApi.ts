...
const normalizeStationCode = (code: any): string => {
    ...
    if (s.length === 6) {
        // As requested: abcdef -> abcdf (drop the 5th digit, which is index 4)
        return s.substring(0, 4) + s.charAt(5);
    }
    return s;
};
...
const QABUL_RULES: Record<string, string> = {
    ...
    // ХОДЖИДАВЛЕТ
    '7571-7300': 'ХОДЖИДАВЛЕТ', '7502-7300': 'ХОДЖИДАВЛЕТ', '7504-7300': 'ХОДЖИДАВЛЕТ',
    // РАЗЪЕЗД 161
    '7568-7351': 'РАЗЪЕЗД 161', '7568-7453': 'РАЗЪЕЗД 161', '7568-7458': 'РАЗЪЕЗД 161',
    '7498-7351': 'РАЗЪЕЗД 161', '7498-7458': 'РАЗЪЕЗД 161', '7504-7453': 'РАЗЪЕЗД 161', '7497-7453': 'РАЗЪЕЗД 161', '7571-7453': 'РАЗЪЕЗД 161',
    // КАРАСУ
    '7180-7437': 'КАРАСУ',
    // ШОЛЛИСОЙ
    '7192-7414': 'ШОЛЛИСОЙ',
